...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='date_time',
            field=models.DateTimeField(default=datetime.datetime(2017, 2, 14, 5, 58, 0, 91602, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='transactionview',
            name='date_time',
            field=models.DateTimeField(default=datetime.datetime(2017, 2, 14, 5, 58, 0, 92480, tzinfo=utc)),
        ),
    ]
